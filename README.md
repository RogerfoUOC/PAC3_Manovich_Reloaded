...
L'experiència en aquests parcs comença abans d'entrar-hi. Es podem fer tours virtuals a través de **[Google Earth](https://earth.google.com/web/@48.87310824,2.77612259,128.27028076a,147.63210641d,35y,-42.92418576h,73.77012318t,0r/data=ClMaURJLCiUweDQ3ZTYxZDE5Y2E3YWUyYmQ6MHg1N2ZhZjhjYjYzMTBlNjYwGRw5d2Clb0hAIdfTs8XaNAZAKhBEaXNuZXlsYW5kIFBhcmlzGAEgAQ)** o a través de la pàgina de **[visitorlando.com](https://www.visitorlando.com/things-to-do/virtual-tours/walt-disney-world-resort/)**, en el cas del parc d'aquesta ciutat. Mentre ens dirigim al parc, podem descarregar l'aplicació mòbil que ens ajudarà a geolocalitzar-nos dins del parc, conèixer el temps d'espera a cada atracció, o a fer reserves pels restaurants. També podem controlar els horaris de diferents espectacles o les rues itinerants dins del parc, i tot des d'una mateixa interfície d'usuari a través de la mateixa app.
...
En aquest cas particular podem dir que no es tracta d'un software que utilitzi l'usuari a través d'una sola interfície, però sí que podem dir que **la combinació de tots aquests elements multimèdia en generen un de nou i únic**, impossible de generar si aïlléssim tots els medis de forma individual.
...
<img src="./WhatsApp.jpeg" width="500">
...
- ["Remediación, multimedia e hibridación de los medios" (Multimedia UOC)](http://multimedia.uoc.edu/blogs/fem/es/remediacio-multimedia-i-hibridacio-dels-mitjans/)
